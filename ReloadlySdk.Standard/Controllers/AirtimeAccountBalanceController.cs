// <copyright file="AirtimeAccountBalanceController.cs" company="APIMatic">
...
namespace ReloadlySdk.Standard.Controllers
{
    ...
    /// </summary>
    public class AirtimeAccountBalanceController : BaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AirtimeAccountBalanceController"/> class.
        /// </summary>
        /// <param name="config"> config instance. </param>
        /// <param name="httpClient"> httpClient. </param>
        /// <param name="authManagers"> authManager. </param>
        internal AirtimeAccountBalanceController(IConfiguration config, IHttpClient httpClient, IDictionary<string, IAuthManager> authManagers)
            : base(config, httpClient, authManagers)
        {
        }

        /// <summary>
        /// reloadly-airtime-account-balance EndPoint.
        /// </summary>
        ...
        public dynamic ReloadlyAirtimeAccountBalance(
                string accept,
                string authorization)
        {
            Task<dynamic> t = this.ReloadlyAirtimeAccountBalanceAsync(accept, authorization);
        ...
        /// <returns>Returns the dynamic response from the API call.</returns>
        public async Task<dynamic> ReloadlyAirtimeAccountBalanceAsync(
                string accept,
                string authorization,
